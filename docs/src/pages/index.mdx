...
- [Olivier Demangeon](https://sed-nge.inria.fr/team/olivierd/index.html) - research engineer - [Loria](https://www.loria.fr), [Inria](https://www.inria.fr)

Contributed in the past:
- [Max Ammann](https://github.com/maxammann) - master's student then security engineer - [Trails of Bits](https://www.trailofbits.com/) at the time
...
We are still looking to hire motivated postdocs/PhD candidates/students/engineers in Nancy, France as part of this project. Open positions are listed [there](https://members.loria.fr/LHirschi/).
