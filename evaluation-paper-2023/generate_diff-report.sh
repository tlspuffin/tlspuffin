...
echo "Don't forget to clone wolfssl530 and openssl111j with 'git clone https://github.com/openssl/openssl --branch OpenSSL_1_1_1j  --single-branch openssl111j' and 'git clone https://github.com/wolfSSL/wolfssl --branch v5.3.0-stable --single-branch'"


####### USER CONFIG
main() {
# Usage:
# generate_diff <diff-folder-out> <cobertura-baseline> <cobertura-new> <PUT> 
	...
	generate_diff diff_AFLNWE-Anvil diff_AFLNWE/results-wolfssl-aflnwe-10/cov.cobertura  /local-unsafe/mammann/tasks/tlsanvil-builds/wolfssl/wolfssl-tlsanvil.cobertura wolfssl &&
	...
	generate_diff diff-BUF-AFLNWE diff_AFLNWE/results-wolfssl-aflnwe-10/cov.cobertura taskBUF/coverage-wolfssl530-test.cobertura  wolfssl &&
