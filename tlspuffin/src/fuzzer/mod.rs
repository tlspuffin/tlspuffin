...
mod tests {
    ...
    use crate::{
        ...
        put_registry::{current_put, CURRENT_PUT_NAME, DUMMY_PUT},
    ...
    fn test_repeat_mutator() {
        ...
        let _trace = seed_client_attacker12(server, current_put());
        ...
        loop {
            let mut trace = seed_client_attacker12(server, current_put());
