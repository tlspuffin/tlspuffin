...
pub fn seed_client_attacker_with_hello_retry_request(server: AgentName) -> Trace<TLSProtocolTypes> {
...
pub fn create_corpus(
    ...
    corpus!(
        ...
        seed_client_attacker_with_hello_retry_request: put.supports("tls13"),
    )
}
