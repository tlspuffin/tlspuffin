...
pub fn create_corpus(
    ...
    corpus!(
        ...
        seed_client_attacker_full_boring: put.supports("tls13") && put.supports("boringssl_binding"),
        ...
        seed_client_attacker_auth_boring: put.supports("tls13") && put.supports("client_authentication_transcript_extraction") && put.supports("boringssl_binding"),
...
pub mod tests {
    ...
    #[apply(test_puts, filter = all(tls12, transcript_extraction))]
    ...
    fn test_seed_client_attacker_full(put: &str) {
        ...
        let ctx = if put.starts_with("boringssl") {
            seed_client_attacker_full_boring.execute_with(put)
        } else {
            seed_client_attacker_full.execute_with(put)
        };
