...
use super::hs;
#[cfg(feature = "logging")]
use crate::tls::rustls::log::trace;
#[cfg(feature = "quic")]
use crate::tls::rustls::msgs::enums::AlertDescription;
use crate::tls::rustls::{
    builder::{ConfigBuilder, WantsCipherSuites},
    conn::{CommonState, ConnectionCommon, Side, State},
    error::Error,
    kx::SupportedKxGroup,
    msgs::{
        base::{Payload, PayloadU8},
        enums::{ProtocolVersion, SignatureScheme},
        handshake::{ClientHelloPayload, ServerExtension},
        message::Message,
    },
    sign,
    suites::SupportedCipherSuite,
    vecbuf::ChunkVecBuffer,
    verify, CipherSuite, KeyLog,
};
#[cfg(feature = "quic")]
use crate::tls::rustls::{conn::Protocol, quic};
...
pub struct ServerConfig {
    ...
    pub(super) versions: crate::tls::rustls::versions::EnabledVersions,
...
impl From<ServerConnection> for crate::tls::rustls::Connection {
...
impl Acceptor {
    ...
    ///
    /// [`Connection::read_tls()`]: crate::tls::rustls::Connection::read_tls
    ...
    pub fn accept(&mut self) -> Result<Option<Accepted>, Error> {
        ...
        let supported_cipher_suites = &crate::tls::rustls::ALL_CIPHER_SUITES;
...
impl Accepted {
    ...
    fn client_hello_payload(message: &Message) -> &ClientHelloPayload {
        match &message.payload {
            crate::tls::rustls::msgs::message::MessagePayload::Handshake(inner) => {
                match &inner.payload {
                    crate::tls::rustls::msgs::handshake::HandshakePayload::ClientHello(ch) => ch,
                    _ => unreachable!(),
                }
            }
            _ => unreachable!(),
...
impl crate::tls::rustls::conn::SideData for ServerConnectionData {}
