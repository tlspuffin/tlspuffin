...
#[cfg(feature = "tls12")]
use crate::tls::rustls::msgs::handshake::SessionID;
use crate::tls::rustls::{
    ...
    msgs::{
        enums::{
            AlertDescription, Compression, ExtensionType, HandshakeType, ProtocolVersion,
            SignatureScheme,
        },
        handshake::{
            ClientHelloPayload, ConvertProtocolNameList, ConvertServerNameList, HandshakePayload,
            Random, ServerExtension,
        },
        message::{Message, MessagePayload},
        persist,
    },
    server::{common::ActiveCertifiedKey, tls13, ClientHello, ServerConfig},
    suites, SupportedCipherSuite,
};

pub(super) type NextState = Box<dyn State<ServerConnectionData>>;
pub(super) type NextStateOrError = Result<NextState, Error>;
pub(super) type ServerContext<'a> = crate::tls::rustls::conn::Context<'a, ServerConnectionData>;
