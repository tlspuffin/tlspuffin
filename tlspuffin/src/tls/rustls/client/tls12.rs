...
use ring::{agreement::PublicKey, constant_time};
...
mod server_hello {
    ...
    pub(in crate::tls::rustls::client) struct CompleteServerHelloHandling {
        pub(in crate::tls::rustls::client) config: Arc<ClientConfig>,
        pub(in crate::tls::rustls::client) resuming_session:
            Option<persist::Tls12ClientSessionValue>,
        pub(in crate::tls::rustls::client) server_name: ServerName,
        pub(in crate::tls::rustls::client) randoms: ConnectionRandoms,
        pub(in crate::tls::rustls::client) using_ems: bool,
        pub(in crate::tls::rustls::client) transcript: HandshakeHash,
    }

    impl CompleteServerHelloHandling {
        pub(in crate::tls::rustls::client) fn handle_server_hello(
            mut self,
