...
///
/// ```no_run
/// # use crate::tls::rustls::tls::rustls::ServerConfig;
/// # let certs = vec![];
/// # let private_key = crate::tls::rustls::tls::rustls::PrivateKey(vec![]);
...
///
/// ```no_run
/// # use crate::tls::rustls::tls::rustls::ClientConfig;
/// # let root_certs = crate::tls::rustls::tls::rustls::RootCertStore::empty();
/// # let certs = vec![];
/// # let private_key = crate::tls::rustls::tls::rustls::PrivateKey(vec![]);
...
///
/// [`ServerConfig`]: crate::tls::rustls::ServerConfig
/// [`ClientConfig`]: crate::tls::rustls::ClientConfig
/// [`ClientConfig::builder()`]: crate::tls::rustls::ClientConfig::builder()
/// [`ServerConfig::builder()`]: crate::tls::rustls::ServerConfig::builder()
...
impl ConfigSide for crate::tls::rustls::ClientConfig {}
impl ConfigSide for crate::tls::rustls::ServerConfig {}

mod sealed {
    pub trait Sealed {}
    impl Sealed for crate::tls::rustls::ClientConfig {}
    impl Sealed for crate::tls::rustls::ServerConfig {}
}
