...
//!
//! ```rust,no_run
//! let mut root_store = crate::tls::rustls::tls::rustls::RootCertStore::empty();
//! root_store.add_server_trust_anchors(
//!     webpki_roots::TLS_SERVER_ROOTS
//!         .0
//!         .iter()
//!         .map(|ta| {
//!             crate::tls::rustls::tls::rustls::OwnedTrustAnchor::from_subject_spki_name_constraints(
//!                 ta.subject,
//!                 ta.spki,
//!                 ta.name_constraints,
//!             )
...
//!
//! ```rust,no_run
//! # let root_store: crate::tls::rustls::tls::rustls::RootCertStore = panic!();
//! let config = crate::tls::rustls::tls::rustls::ClientConfig::builder()
//!     .with_safe_defaults()
...
//! let mut client = crate::tls::rustls::tls::rustls::ClientConnection::new(rc_config, example_com);
//! ```
//!
...
//!
//! ```rust,no_run
//! # let mut client = crate::tls::rustls::tls::rustls::ClientConnection::new(panic!(), panic!()).unwrap();
//! # struct Socket { }
//! # impl Socket {
...
//! # }
//! use std::io;
//! use crate::tls::rustls::tls::rustls::Connection;
//!
...
pub mod internal {
    ...
    pub mod msgs {
        pub use crate::tls::rustls::msgs::*;
    }
    /// Low-level TLS message decryption functions.
    pub mod cipher {
        pub use crate::tls::rustls::cipher::MessageDecrypter;
    }
}

// The public interface is:
#[cfg(feature = "tls12")]
pub use crate::tls::rustls::tls12::Tls12CipherSuite;
pub use crate::tls::rustls::{
    anchors::{OwnedTrustAnchor, RootCertStore},
    builder::{
        ConfigBuilder, ConfigSide, WantsCipherSuites, WantsKxGroups, WantsVerifier, WantsVersions,
    },
    conn::{CommonState, Connection, ConnectionCommon, IoState, Reader, SideData, Writer},
    error::{CorruptMessagePayload, Error},
...
pub mod client {
    ...
    #[cfg(feature = "dangerous_configuration")]
    #[cfg_attr(docsrs, doc(cfg(feature = "dangerous_configuration")))]
    pub use crate::tls::rustls::verify::{
...
pub mod server {
    ...
    #[cfg(feature = "dangerous_configuration")]
    #[cfg_attr(docsrs, doc(cfg(feature = "dangerous_configuration")))]
    pub use crate::tls::rustls::verify::{ClientCertVerified, ClientCertVerifier, DnsName};
}

pub use server::{ServerConfig, ServerConnection};

use crate::tls::rustls::msgs::{deframer::MessageDeframer, message::PlainMessage};
...
pub mod cipher_suite {
    #[cfg(feature = "tls12")]
    pub use crate::tls::rustls::tls12::TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256;
    #[cfg(feature = "tls12")]
    pub use crate::tls::rustls::tls12::TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384;
    #[cfg(feature = "tls12")]
    pub use crate::tls::rustls::tls12::TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256;
    #[cfg(feature = "tls12")]
    pub use crate::tls::rustls::tls12::TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256;
    #[cfg(feature = "tls12")]
    pub use crate::tls::rustls::tls12::TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384;
    #[cfg(feature = "tls12")]
    pub use crate::tls::rustls::tls12::TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256;
    pub use crate::tls::rustls::{
...
pub mod version {
    #[cfg(feature = "tls12")]
    pub use crate::tls::rustls::versions::TLS12;
    pub use crate::tls::rustls::versions::TLS13;
}
...
pub mod kx_group {
    pub use crate::tls::rustls::kx::{SECP256R1, SECP384R1, X25519};
}
...
impl puffin::protocol::Message<crate::tls::rustls::msgs::message::OpaqueMessage>
    for crate::tls::rustls::msgs::message::Message
{
    fn create_opaque(&self) -> crate::tls::rustls::msgs::message::OpaqueMessage {
...
impl
    puffin::protocol::MessageDeframer<
        crate::tls::rustls::msgs::message::Message,
        crate::tls::rustls::msgs::message::OpaqueMessage,
    > for MessageDeframer
{
    fn new() -> Self {
        MessageDeframer::new()
    }
    fn pop_frame(&mut self) -> Option<crate::tls::rustls::msgs::message::OpaqueMessage> {
...
impl puffin::protocol::OpaqueMessage<crate::tls::rustls::msgs::message::Message>
    for crate::tls::rustls::msgs::message::OpaqueMessage
{
    fn encode(&self) -> Vec<u8> {
        self.clone().encode()
    }
    ...
    fn into_message(
        self,
    ) -> Result<crate::tls::rustls::msgs::message::Message, puffin::error::Error> {
...
impl puffin::algebra::Matcher for crate::tls::rustls::internal::msgs::enums::HandshakeType {
