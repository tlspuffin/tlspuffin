...
#[cfg(feature = "logging")]
use crate::tls::rustls::log::{debug, error, trace, warn};
#[cfg(feature = "quic")]
...
pub enum Connection {
    /// A client connection
    Client(crate::tls::rustls::client::ClientConnection),
    /// A server connection
    Server(crate::tls::rustls::server::ServerConnection),
}
...
#[cfg(feature = "quic")]
impl crate::tls::rustls::quic::QuicExt for Connection {
...
impl CommonState {
    ...
    pub fn decrypt_incoming(&mut self, encr: OpaqueMessage) -> Result<Option<PlainMessage>, Error> {
