use puffin::{
    agent::TLSVersion, execution::Runner, put::PutDescriptor, put_registry::TCP_PUT, trace::Spawner,
};
#[allow(unused_imports)]
use tlspuffin::{test_utils::prelude::*, tls::seeds::*, tls::vulnerabilities::*};

// Heartbleed: vulnerable up until OpenSSL 1.0.1f
...
// FREAK: vulnerable up until OpenSSL 1.0.1j
#[cfg(all(feature = "openssl101-binding", feature = "asan"))]
#[cfg(feature = "tls12")]
#[test_log::test]
...
fn cve_2022_38152() {
    expect_trace_crash(
        ...
        default_runner_for(PutDescriptor::new(
...
fn tcp_wolfssl_openssl_cve_2022_38153() {
