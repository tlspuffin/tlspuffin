...
|---|---|---|---|
| **Producer** | Claude Haiku 4.6 | One-shot per campaign | Pure I/O — runs the Phase 0 shell script and verifies counts. Near-zero token cost. |
| **Orchestrator** | Claude Sonnet 4.8 (Pro plan), Claude Code CLI in tmux | Persistent through campaign | Mid-tier. Handles synthesis: bucket conditions, bug reports, reproducers. Token budget is the binding constraint. |
