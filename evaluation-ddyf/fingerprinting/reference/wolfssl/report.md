...
- Distinct probe traces used: **7** (of 77 confirmed)
- Informative probes (distinguish >= 1 pair): 53

**Live deployment validation:** **26/26** servers recognised, 26/26 consistently across 5 walks, <= 4 traces each. _Honest, deployment-validated number._

## Reliably-distinguishable clusters (14)

Two versions share a cluster iff no probe gives them stably-different live responses.

- **C0** (4): 5.5.0, 5.5.1, 5.5.2, 5.5.3
- **C1** (4): 5.6.0, 5.6.2, 5.6.3, 5.6.4
- **C2** (3): 5.1.0, 5.1.1, 5.2.0
- **C3** (3): 5.7.6, 5.8.0, 5.8.2
- **C4** (2): 5.0.0, 5.2.1
- **C5** (2): 5.9.0, 5.9.1
- **C6** (1): 5.3.0
- **C7** (1): 5.4.0
