...
- Distinguishable clusters (tree leaves): **10**
- Tree depth: **3** -> identify any server by replaying **<= 3 traces**
- Distinct probe traces used: **3** (of 275 confirmed)
- Informative probes (distinguish >= 1 pair): 262

**Live deployment validation:** **61/61** servers recognised, 61/61 consistently across 5 walks, <= 3 traces each. _Honest, deployment-validated number._

## Reliably-distinguishable clusters (10)
...
- **C4** (6): 3.5.0, 3.5.1, 3.5.2, 3.5.3, 3.5.4, 3.5.5
