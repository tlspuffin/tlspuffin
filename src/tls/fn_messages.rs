...
pub fn fn_certificate(certificate: &CertificatePayload) -> Result<Message, FnError> {
    Ok(Message {
        version: ProtocolVersion::TLSv1_2, // todo this is not controllable
        payload: MessagePayload::Handshake(HandshakeMessagePayload {
...
pub fn fn_server_certificate(certs: &CertificatePayload) -> Result<Message, FnError> {
    Ok(Message {
        version: ProtocolVersion::TLSv1_2, // todo this is not controllable
        payload: MessagePayload::Handshake(HandshakeMessagePayload {
            typ: HandshakeType::Certificate,
...
pub fn fn_change_cipher_spec12() -> Result<Message, FnError> {
    Ok(Message {
        version: ProtocolVersion::TLSv1_2, // todo this is not controllable
        payload: MessagePayload::ChangeCipherSpec(ChangeCipherSpecPayload),
    })
...
pub fn fn_finished12(data: &Vec<u8>) -> Result<Message, FnError> {
    Ok(Message {
        version: ProtocolVersion::TLSv1_2, // todo this is not controllable
        payload: MessagePayload::Handshake(HandshakeMessagePayload {
            typ: HandshakeType::Finished,
