...
pub mod integration {
    ...
    fn a<'a>(data: &'a [u8]) {
        let message1: TlsMessage<'a> = TlsMessage::Handshake(TlsMessageHandshake::CertificateVerify(data));
    ...
    fn test_tlsparser() {
        ...
        let message: TlsMessage<'static> = TlsMessage::Handshake(TlsMessageHandshake::EndOfEarlyData);
