...
//! Extracted from https://github.com/warp-tech/russh/commit/12dc53690a665b3c1be2bfb7f4c3f8cd95e0469b
//!
//! Copy-and-pasting this into the project is simpler than depending on it.
//!
...
type Sha256Hash = generic_array::GenericArray<u8, <sha2::Sha256 as OutputSizeUser>::OutputSize>;
...
mod test_compress {
    ...
    use super::{
        server::{Auth, Server as _, Session},
        *,
    };
