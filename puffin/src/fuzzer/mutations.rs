...
use super::utils::{
    ...
    find_term_mut, reservoir_sample,
...
use crate::trace::{Action, Query, Spawner, Trace, TraceContext};
...
mod tests {
    ...
    fn test_dy_mutators_preserve_deconstructor_sources() {
        ...
        let mut replace_match = ReplaceMatchMutator::new(MutationConfig::default(), &TEST_SIGNATURE);
